...
k17 = linspace(5,15,5); %choose random, dense dataset
k2 = linspace(8,20,5);
...
%% extracting data
 getdata = readmatrix('dataset4.csv');
...
net1.performParam.normalization = 'percent';
...
net2.performParam.normalization = 'percent';
...
net3.performParam.normalization = 'percent';
...
net4.performParam.normalization = 'percent';
...
net5.performParam.normalization = 'percent';
...
net6.performParam.normalization = 'percent';
...
net7.performParam.normalization = 'percent';

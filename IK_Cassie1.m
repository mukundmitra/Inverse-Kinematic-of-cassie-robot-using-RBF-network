...
k17 = linspace(5,12,7);
k2 = linspace(6,20,7);
k34 = linspace(10,24,7);
k56 = linspace(-10,11,7);
...
csvwrite('dataset_fk1.csv',pose_end_effector);
...
csvwrite('dataset_thetas1.csv',theta);

%% extracting csv data 
data_from_csv = readmatrix('dataset_fk1.csv');
theta_from_csv = readmatrix('dataset_thetas1.csv');

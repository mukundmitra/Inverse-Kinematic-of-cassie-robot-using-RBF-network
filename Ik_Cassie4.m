...
csvwrite('dataset_thetas4',theta);
...
csvwrite('dataset_fk4.csv',pose_end_effector);

disp('Forward kinematics done');

%% Extracting data drom csv
data_from_csv = readmatrix('dataset_fk2.csv');
theta_from_csv = readmatrix('dataset_thetas2.csv');
